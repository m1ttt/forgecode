...
use anyhow::Result;
use artemis_app::ConversationService;
use artemis_app::domain::{Conversation, ConversationId};
use artemis_domain::ConversationRepository;
...
impl<S: ConversationRepository> ConversationService for ForgeConversationService<S> {
        ...
        T: Send,
    {
        let mut conversation = self
            ...
            .get_conversation(id)
            .await?
            .ok_or_else(|| artemis_app::domain::Error::ConversationNotFound(*id))?;
