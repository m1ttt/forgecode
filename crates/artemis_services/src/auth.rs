...
use artemis_app::{AuthService, EnvironmentInfra, HttpInfra, User, UserUsage};
use reqwest::Url;
...
impl<I: HttpInfra + EnvironmentInfra<Config = artemis_config::ForgeConfig>> ForgeAuthService<I> {
...
impl<I: HttpInfra + EnvironmentInfra<Config = artemis_config::ForgeConfig>> AuthService
