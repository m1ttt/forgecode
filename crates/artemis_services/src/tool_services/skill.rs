...
use artemis_app::SkillFetchService;
use artemis_domain::Skill;
...
impl<R: artemis_domain::SkillRepository> SkillFetchService for ForgeSkillFetch<R> {
...
impl<R: artemis_domain::SkillRepository> ForgeSkillFetch<R> {
...
mod tests {
    ...
    #[async_trait::async_trait]
    impl artemis_domain::SkillRepository for MockSkillRepository {
