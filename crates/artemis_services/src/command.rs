...
use artemis_app::domain::Command;
use artemis_app::{
...
impl<F: FileReaderInfra + FileWriterInfra + FileInfoInfra + EnvironmentInfra + DirectoryReaderInfra>
    artemis_app::CommandLoaderService for CommandLoaderService<F>
{
...
mod tests {
    ...
    async fn test_parse_basic_command() {
        let content = artemis_test_kit::fixture!("src/fixtures/commands/basic.md").await;
    ...
    async fn test_parse_command_with_multiline_prompt() {
        let content = artemis_test_kit::fixture!("src/fixtures/commands/multiline.md").await;
    ...
    async fn test_parse_invalid_frontmatter() {
        let content = artemis_test_kit::fixture!("src/fixtures/commands/invalid.md").await;
    ...
    async fn test_parse_builtin_commands() {
        ...
        for (name, path) in builtin_commands {
            let content = artemis_test_kit::fixture!(path).await;
