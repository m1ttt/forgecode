...
use dashmap::DashMap;
use artemis_app::domain::AgentId;
use artemis_app::{AgentRepository, EnvironmentInfra};
use artemis_domain::{Agent, AgentInfo};
...
impl<R: AgentRepository + EnvironmentInfra<Config = artemis_config::ForgeConfig>>
...
impl<R: AgentRepository + EnvironmentInfra<Config = artemis_config::ForgeConfig> + Send + Sync>
    artemis_app::AgentRegistry for ForgeAgentRegistryService<R>
{
