...
use artemis_tool_macros::ToolDescription;
...
#[tool_description_file = "crates/artemis_domain/src/tools/descriptions/task.md"]
pub struct TaskInput {
    ...
    /// The ID of the specialized agent to delegate to (e.g., "sage", "artemis",
    /// "muse")
    pub agent_id: String,
...
#[derive(Default, Debug, Clone, Serialize, Deserialize, JsonSchema, ToolDescription, PartialEq)]
#[tool_description_file = "crates/artemis_domain/src/tools/descriptions/fs_read.md"]
pub struct FSRead {
...
#[derive(Default, Debug, Clone, Serialize, Deserialize, JsonSchema, ToolDescription, PartialEq)]
#[tool_description_file = "crates/artemis_domain/src/tools/descriptions/fs_write.md"]
pub struct FSWrite {
...
#[tool_description_file = "crates/artemis_domain/src/tools/descriptions/fs_search.md"]
#[derive(Default)]
pub struct FSSearch {
...
#[derive(Default, Debug, Clone, Serialize, Deserialize, JsonSchema, ToolDescription, PartialEq)]
#[tool_description_file = "crates/artemis_domain/src/tools/descriptions/semantic_search.md"]
...
#[derive(Default, Debug, Clone, Serialize, Deserialize, JsonSchema, ToolDescription, PartialEq)]
#[tool_description_file = "crates/artemis_domain/src/tools/descriptions/fs_remove.md"]
pub struct FSRemove {
...
#[derive(Default, Debug, Clone, Serialize, Deserialize, JsonSchema, ToolDescription, PartialEq)]
#[tool_description_file = "crates/artemis_domain/src/tools/descriptions/fs_patch.md"]
pub struct FSPatch {
...
#[derive(Default, Debug, Clone, Serialize, Deserialize, JsonSchema, ToolDescription, PartialEq)]
#[tool_description_file = "crates/artemis_domain/src/tools/descriptions/fs_multi_patch.md"]
...
#[derive(Default, Debug, Clone, Serialize, Deserialize, JsonSchema, ToolDescription, PartialEq)]
#[tool_description_file = "crates/artemis_domain/src/tools/descriptions/fs_undo.md"]
pub struct FSUndo {
...
#[derive(Default, Debug, Clone, Serialize, Deserialize, JsonSchema, ToolDescription, PartialEq)]
#[tool_description_file = "crates/artemis_domain/src/tools/descriptions/shell_exec.md"]
pub struct ShellExec {
    /// The shell command to execute synchronously.
    pub command: String,
...
#[derive(Default, Debug, Clone, Serialize, Deserialize, JsonSchema, ToolDescription, PartialEq)]
#[tool_description_file = "crates/artemis_domain/src/tools/descriptions/shell.md"]
pub struct Shell {
...
#[derive(Default, Debug, Clone, Serialize, Deserialize, JsonSchema, ToolDescription, PartialEq)]
#[tool_description_file = "crates/artemis_domain/src/tools/descriptions/shell_poll.md"]
pub struct ShellPoll {
    /// Job identifier returned by the shell tool.
    pub job_id: u64,

    /// Whether to preserve ANSI escape codes in output.
    #[serde(default)]
    #[serde(skip_serializing_if = "is_default")]
    pub keep_ansi: bool,
}
...
#[derive(Default, Debug, Clone, Serialize, Deserialize, JsonSchema, ToolDescription, PartialEq)]
#[tool_description_file = "crates/artemis_domain/src/tools/descriptions/shell_wait.md"]
pub struct ShellWait {
    /// Job identifier returned by the shell tool.
    pub job_id: u64,

    /// Maximum time to wait in milliseconds. If omitted, waits until completion.
    #[serde(default)]
    #[serde(skip_serializing_if = "Option::is_none")]
...
#[derive(Default, Debug, Clone, Serialize, Deserialize, JsonSchema, ToolDescription, PartialEq)]
#[tool_description_file = "crates/artemis_domain/src/tools/descriptions/shell_kill.md"]
...
#[derive(Default, Debug, Clone, Serialize, Deserialize, JsonSchema, ToolDescription, PartialEq)]
#[tool_description_file = "crates/artemis_domain/src/tools/descriptions/net_fetch.md"]
pub struct NetFetch {
    /// URL to fetch
    pub url: String,
...
#[derive(Default, Debug, Clone, Serialize, Deserialize, JsonSchema, ToolDescription, PartialEq)]
#[tool_description_file = "crates/artemis_domain/src/tools/descriptions/followup.md"]
pub struct Followup {
...
#[derive(Default, Debug, Clone, Serialize, Deserialize, JsonSchema, ToolDescription, PartialEq)]
#[tool_description_file = "crates/artemis_domain/src/tools/descriptions/plan_create.md"]
...
#[derive(Default, Debug, Clone, Serialize, Deserialize, JsonSchema, ToolDescription, PartialEq)]
#[tool_description_file = "crates/artemis_domain/src/tools/descriptions/skill_fetch.md"]
...
#[derive(Default, Debug, Clone, Serialize, Deserialize, JsonSchema, ToolDescription, PartialEq)]
#[tool_description_file = "crates/artemis_domain/src/tools/descriptions/todo_write.md"]
...
#[derive(Default, Debug, Clone, Serialize, Deserialize, JsonSchema, ToolDescription, PartialEq)]
#[tool_description_file = "crates/artemis_domain/src/tools/descriptions/todo_read.md"]
pub struct TodoRead {}
...
impl ToolDescription for ToolCatalog {
    fn description(&self) -> String {
        match self {
            ...
            ToolCatalog::ShellExec(v) => v.description(),
            ToolCatalog::ShellPoll(v) => v.description(),
            ToolCatalog::ShellWait(v) => v.description(),
            ToolCatalog::ShellKill(v) => v.description(),
...
impl ToolCatalog {
    pub fn schema(&self) -> Schema {
        ...
        let mut schema = match self {
            ...
            ToolCatalog::ShellExec(_) => r#gen.into_root_schema_for::<ShellExec>(),
            ToolCatalog::ShellPoll(_) => r#gen.into_root_schema_for::<ShellPoll>(),
            ToolCatalog::ShellWait(_) => r#gen.into_root_schema_for::<ShellWait>(),
            ToolCatalog::ShellKill(_) => r#gen.into_root_schema_for::<ShellKill>(),
    ...
    pub fn to_policy_operation(
        ...
        match self {
            ...
            ToolCatalog::ShellExec(input) => Some(crate::policies::PermissionOperation::Execute {
                command: input.command.clone(),
                cwd,
            }),
            ...
            | ToolCatalog::ShellPoll(_)
            | ToolCatalog::ShellWait(_)
            | ToolCatalog::ShellKill(_)
            | ToolCatalog::Undo(_)
    ...
    /// Creates a ShellExec tool call with the specified command and working
    /// directory (synchronous, blocking)
    pub fn tool_call_shell_exec(command: &str, cwd: impl Into<PathBuf>) -> ToolCallFull {
        ToolCallFull::from(ToolCatalog::ShellExec(ShellExec {
            command: command.to_string(),
            cwd: Some(cwd.into()),
            ..Default::default()
        }))
    ...
    fn try_from(value: ToolCallFull) -> Result<Self, Self::Error> {
        ...
        let coerced_args = ToolCatalog::iter()
            ...
            .map(|tool| {
                ...
                artemis_json_repair::coerce_to_schema(parsed_args.clone(), &schema)
            })
