...
impl AgentId {
    ...
    pub const ARTEMIS: AgentId = AgentId(Cow::Borrowed("artemis"));
...
pub struct ReasoningConfig {
    ...
    /// supported by openrouter and artemis provider
    #[serde(skip_serializing_if = "Option::is_none")]
    pub effort: Option<Effort>,

    /// Controls how many tokens the model can spend thinking.
    /// supported by openrouter, anthropic and artemis provider
