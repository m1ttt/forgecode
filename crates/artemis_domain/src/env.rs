...
impl Environment {
    ...
    pub fn history_path(&self, custom_path: Option<&PathBuf>) -> PathBuf {
        custom_path
            .cloned()
            .unwrap_or(self.base_path.join(".artemis_history"))
    }
    ...
    pub fn database_path(&self) -> PathBuf {
        self.base_path.join(".artemis.db")
    }
    ...
    /// Returns the project-local skills directory path (.artemis/skills)
    pub fn local_skills_path(&self) -> PathBuf {
        self.cwd.join(".artemis/skills")
    }
    ...
    /// Returns the project-local commands directory path (.artemis/commands)
    pub fn command_path_local(&self) -> PathBuf {
        self.cwd.join(".artemis/commands")
    }
...
mod tests {
    ...
    fn test_agent_cwd_path() {
        ...
        let expected = PathBuf::from("/current/working/dir/.artemis/agents");
    ...
    fn test_agent_cwd_path_independent_from_agent_path() {
        ...
        let expected_agent_cwd_path = PathBuf::from("/different/current/dir/.artemis/agents");
    ...
    fn test_global_skills_path() {
        let fixture: Environment = Faker.fake();
        let fixture = fixture.base_path(PathBuf::from("/home/user/.artemis"));

        let actual = fixture.global_skills_path();
        let expected = PathBuf::from("/home/user/.artemis/skills");
    ...
    fn test_local_skills_path() {
        ...
        let expected = PathBuf::from("/projects/my-app/.artemis/skills");
    ...
    fn test_skills_paths_independent() {
        ...
        let fixture = fixture
            ...
            .base_path(PathBuf::from("/home/user/.artemis"));

        let global_path = fixture.global_skills_path();
        let local_path = fixture.local_skills_path();

        let expected_global = PathBuf::from("/home/user/.artemis/skills");
        let expected_local = PathBuf::from("/projects/my-app/.artemis/skills");
    ...
    fn test_command_path() {
        ...
        let expected = PathBuf::from("/home/user/.artemis/commands");
    ...
    fn test_command_path_local() {
        ...
        let expected = PathBuf::from("/projects/my-app/.artemis/commands");
    ...
    fn test_command_paths_independent() {
        ...
        let expected_global = PathBuf::from("/home/user/.artemis/commands");
        let expected_local = PathBuf::from("/projects/my-app/.artemis/commands");
    ...
    fn test_global_agents_md_path() {
        ...
        let expected = PathBuf::from("/home/user/.artemis/AGENTS.md");
    ...
    fn test_provider_config_path() {
        ...
        let expected = PathBuf::from("/home/user/.artemis/provider.json");
