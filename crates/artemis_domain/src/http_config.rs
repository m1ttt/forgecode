...
/// # Example
/// ```
/// use artemis_domain::{HttpConfig, TlsVersion, TlsBackend};
///
...
/// - `ARTEMIS_HTTP_MIN_TLS_VERSION`: Set minimum TLS version (e.g., "1.2")
/// - `ARTEMIS_HTTP_MAX_TLS_VERSION`: Set maximum TLS version (e.g., "1.3")
...
/// - `ARTEMIS_HTTP_CONNECT_TIMEOUT`: Connection timeout in seconds (default: 30)
/// - `ARTEMIS_HTTP_READ_TIMEOUT`: Read timeout in seconds (default: 900)
/// - `ARTEMIS_HTTP_POOL_IDLE_TIMEOUT`: Pool idle timeout in seconds (default: 90)
/// - `ARTEMIS_HTTP_POOL_MAX_IDLE_PER_HOST`: Max idle connections per host
///   (default: 5)
/// - `ARTEMIS_HTTP_MAX_REDIRECTS`: Maximum redirects to follow (default: 10)
/// - `ARTEMIS_HTTP_USE_HICKORY`: Use Hickory DNS resolver (default: false)
/// - `ARTEMIS_HTTP_TLS_BACKEND`: TLS backend ("default" or "rustls", default:
///   "default")
/// - `ARTEMIS_HTTP_MIN_TLS_VERSION`: Minimum TLS version ("1.0", "1.1", "1.2",
///   "1.3")
/// - `ARTEMIS_HTTP_MAX_TLS_VERSION`: Maximum TLS version ("1.0", "1.1", "1.2",
///   "1.3")
/// - `ARTEMIS_HTTP_ADAPTIVE_WINDOW`: Enable HTTP/2 adaptive window (default:
///   true)
/// - `ARTEMIS_HTTP_KEEP_ALIVE_INTERVAL`: Keep-alive interval in seconds (default:
///   60, use "none"/"disabled" to disable)
/// - `ARTEMIS_HTTP_KEEP_ALIVE_TIMEOUT`: Keep-alive timeout in seconds (default:
///   10)
/// - `ARTEMIS_HTTP_KEEP_ALIVE_WHILE_IDLE`: Keep-alive while idle (default: true)
/// - `ARTEMIS_HTTP_ACCEPT_INVALID_CERTS`: Accept invalid certificates (default:
///   false) - USE WITH CAUTION
/// - `ARTEMIS_HTTP_ROOT_CERT_PATHS`: Paths to root certificate files (PEM, CRT,
