use artemis_app::domain::Error as DomainError;
use artemis_app::dto::anthropic::Error as AnthropicError;
use artemis_app::dto::openai::{Error, ErrorResponse};
...
mod tests {
    use anyhow::anyhow;
    use artemis_app::dto::openai::{Error, ErrorCode, ErrorResponse};
