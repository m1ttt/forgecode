...
use anyhow::Result;
use artemis_domain::{Environment, Snapshot, SnapshotRepository};

pub struct ForgeFileSnapshotService {
    inner: Arc<artemis_snaps::SnapshotService>,
}

impl ForgeFileSnapshotService {
    pub fn new(env: Environment) -> Self {
        Self {
            inner: Arc::new(artemis_snaps::SnapshotService::new(env.snapshot_path())),
        }
    }
}
