...
use anyhow::Context;
use artemis_app::domain::Skill;
use artemis_app::{EnvironmentInfra, FileInfoInfra, FileReaderInfra, Walker, WalkerInfra};
...
/// 2. Global custom skills (from ~/.artemis/skills/ directory)
/// 3. Agents skills (from ~/.agents/skills/ directory)
/// 4. Project-local skills (from .artemis/skills/ directory in current working
///    directory)
///
/// ## Skill Precedence
...
/// - **Global skills**: `~/.artemis/skills/<skill-name>/SKILL.md`
/// - **Agents skills**: `~/.agents/skills/<skill-name>/SKILL.md`
/// - **CWD skills**: `./.artemis/skills/<skill-name>/SKILL.md` (relative to
...
impl<I: FileInfoInfra + EnvironmentInfra + FileReaderInfra + WalkerInfra> ForgeSkillRepository<I> {
    ...
    fn render_skill(&self, skill: Skill, env: &artemis_domain::Environment) -> Skill {
...
mod tests {
    ...
    async fn test_extract_skill_with_valid_metadata() {
        ...
        let content =
            artemis_test_kit::fixture!("/src/fixtures/skills/with_name_and_description.md").await;
    ...
    async fn test_extract_skill_with_incomplete_metadata() {
        // Fixture
        let content = artemis_test_kit::fixture!("/src/fixtures/skills/with_name_only.md").await;
