...
use artemis_domain::{ChatResponseContent, Environment, TitleFormat};
...
impl FormatContent for ToolOperation {
    fn to_content(&self, env: &Environment) -> Option<ChatResponseContent> {
        match self {
            ...
            | ToolOperation::ShellStart { output: _ }
            | ToolOperation::ShellPoll { output: _ }
            | ToolOperation::ShellWait { output: _ }
            | ToolOperation::ShellKill { output: _ }
...
mod tests {
    ...
    use artemis_display::DiffFormat;
    use artemis_domain::{ChatResponseContent, Environment, FileInfo};
    ...
    fn test_fs_create_with_warning() {
        ...
        let fixture = ToolOperation::FsWrite {
            ...
            output: FsWriteOutput {
                ...
                before: None,
                errors: vec![artemis_domain::SyntaxError {
                    line: 5,
                    column: 10,
    ...
    fn test_fs_remove() {
        let fixture = ToolOperation::FsRemove {
            input: artemis_domain::FSRemove { path: "/home/user/project/file.txt".to_string() },
    ...
    fn test_fs_undo() {
        let fixture = ToolOperation::FsUndo {
            input: artemis_domain::FSUndo { path: "/home/user/project/test.txt".to_string() },
            output: FsUndoOutput {
    ...
    fn test_plan_create() {
        let fixture = ToolOperation::PlanCreate {
            input: artemis_domain::PlanCreate {
        ...
        if let Some(ChatResponseContent::ToolInput(title)) = actual {
            ...
            assert_eq!(title.category, artemis_domain::Category::Debug);
