...
pub(crate) fn build_template_config(config: &ForgeConfig) -> artemis_domain::TemplateConfig {
    artemis_domain::TemplateConfig {
...
impl<S: Services + EnvironmentInfra<Config = artemis_config::ForgeConfig>> ForgeApp<S> {
    ...
    pub async fn chat(
        ...
        let conversation = services
            ...
            .await?
            .ok_or_else(|| artemis_domain::Error::ConversationNotFound(chat.conversation_id))?;
    ...
    pub async fn compact_conversation(
        ...
        let mut conversation = self
            ...
            .await?
            .ok_or_else(|| artemis_domain::Error::ConversationNotFound(*conversation_id))?;
