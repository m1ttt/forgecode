use artemis_domain::{ChatCompletionMessage, CommandOutput, Content, FinishReason};
...
async fn test_system_prompt_tool_supported() {
    let mut ctx = TestContext::default()
        .files(vec![
            artemis_domain::File { path: "/users/john/foo.txt".to_string(), is_dir: false },
            artemis_domain::File { path: "/users/jason/bar.txt".to_string(), is_dir: false },
        ])
