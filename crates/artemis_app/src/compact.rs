    ...
    fn compress_single_sequence(
        ...
        if let Some(reasoning) = reasoning_details
            && let Some(ContextMessage::Text(msg)) = context
                .messages
                .iter_mut()
                .find(|msg| msg.has_role(artemis_domain::Role::Assistant))
                .map(|msg| &mut **msg)
            && msg
                .reasoning_details
                .as_ref()
...
mod tests {
    ...
    use artemis_domain::MessageEntry;
    ...
    fn test_template_engine_renders_summary_frame() {
        use artemis_domain::{ContextSummary, Role, SummaryBlock, SummaryMessage, SummaryToolCall};
        ...
        let messages = vec![
            ...
            SummaryBlock::new(
                Role::Assistant,
                vec![
                    SummaryToolCall::codebase_search(vec![artemis_domain::SearchQuery::new(
    ...
    fn test_template_engine_renders_todo_write() {
        ...
        let messages = vec![
            ...
            SummaryBlock::new(
                ...
                vec![
                    SummaryToolCall {
                        id: Some(artemis_domain::ToolCallId::new("call_1")),
    ...
    async fn test_render_summary_frame_snapshot() {
        ...
        let fixture_json = artemis_test_kit::fixture!("/src/fixtures/conversation.json").await;

        let conversation: artemis_domain::Conversation =
    ...
    fn test_compaction_preserves_usage_information() {
        use artemis_domain::{TokenCount, Usage};
    ...
    fn ctx(pattern: &str) -> Context {
        artemis_domain::MessagePattern::new(pattern).build()
    }
