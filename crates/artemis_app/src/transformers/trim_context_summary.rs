use artemis_domain::{ContextSummary, Role, SummaryMessage, SummaryTool, Transformer};
...
enum Operation<'a> {
    ...
    CodebaseSearch {
        queries: &'a [artemis_domain::SearchQuery],
    },
...
#[cfg(test)]
mod tests {
    use artemis_domain::{Role, SummaryBlock, SummaryToolCall, ToolCallId};
