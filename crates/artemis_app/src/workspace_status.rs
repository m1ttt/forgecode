...
use artemis_domain::{FileHash, FileStatus, SyncProgress, SyncStatus};
    ...
    fn test_file_statuses() {
        ...
        let expected = vec![
            artemis_domain::FileStatus::new(
                ...
                artemis_domain::SyncStatus::InSync,
            ),
            artemis_domain::FileStatus::new(
                "/workspace/b.rs".to_string(),
                artemis_domain::SyncStatus::Modified,
            ),
            artemis_domain::FileStatus::new(
                "/workspace/c.rs".to_string(),
                artemis_domain::SyncStatus::Deleted,
            ),
            artemis_domain::FileStatus::new(
                "/workspace/d.rs".to_string(),
                artemis_domain::SyncStatus::New,
            ),
        ];
