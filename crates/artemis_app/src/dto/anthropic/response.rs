...
impl From<Model> for artemis_domain::Model {
    fn from(value: Model) -> Self {
        ...
        {
            vec![
                artemis_domain::InputModality::Text,
                artemis_domain::InputModality::Image,
            ]
        } else {
            vec![artemis_domain::InputModality::Text]
        };
...
impl From<Usage> for artemis_domain::Usage {
...
impl From<StopReason> for artemis_domain::FinishReason {
    fn from(value: StopReason) -> Self {
        match value {
            StopReason::EndTurn => artemis_domain::FinishReason::Stop,
            StopReason::MaxTokens => artemis_domain::FinishReason::Length,
            StopReason::StopSequence => artemis_domain::FinishReason::Stop,
            StopReason::ToolUse => artemis_domain::FinishReason::ToolCalls,
        }
    }
}
    ...
    fn try_from(value: Event) -> Result<Self, Self::Error> {
        let result = match value {
            ...
            Event::Ping { cost: Some(cost) } => {
                ...
                ChatCompletionMessage::assistant(Content::part(""))
                    .usage(artemis_domain::Usage { cost: Some(cost_value), ..Default::default() })
            }
...
mod tests {
    ...
    fn test_usage_conversion_with_cache_read_tokens() {
        ...
        let actual: artemis_domain::Usage = fixture.into();
    ...
    fn test_vertex_ai_streaming_usage() {
        ...
        let initial_domain: artemis_domain::Usage = initial_usage.into();
        let delta_domain: artemis_domain::Usage = delta_usage.into();
    ...
    fn test_model_conversion_includes_context_length() {
        ...
        let actual: artemis_domain::Model = fixture.into();
    ...
    fn test_ping_event_with_cost_produces_usage() {
        ...
        let expected_usage = artemis_domain::Usage { cost: Some(0.00724710), ..Default::default() };
