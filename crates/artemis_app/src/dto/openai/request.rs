...
use artemis_json_repair::coerce_to_schema;
...
pub struct Request {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub reasoning: Option<artemis_domain::ReasoningConfig>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    fn from(context: Context) -> Self {
        Request {
            ...
            response_format: context.response_format.map(|rf| match rf {
                artemis_domain::ResponseFormat::Text => ResponseFormat::Text,
...
impl From<artemis_domain::Role> for Role {
    fn from(role: artemis_domain::Role) -> Self {
        match role {
            artemis_domain::Role::System => Role::System,
            artemis_domain::Role::User => Role::User,
            artemis_domain::Role::Assistant => Role::Assistant,
        }
    }
}
...
<task>
    ...
    fn test_assistant_message_with_dump_style_tool_call_arguments_conversion() {
        ...
        .arguments(
            serde_json::from_str::<artemis_domain::ToolCallArguments>(
    ...
    fn test_context_conversion_stream_defaults_to_true() {
        let fixture = artemis_domain::Context::default();
    ...
    fn test_context_conversion_stream_explicit_true() {
        let fixture = artemis_domain::Context::default().stream(true);
        let actual = Request::from(fixture);
    ...
    fn test_context_conversion_stream_explicit_false() {
        let fixture = artemis_domain::Context::default().stream(false);
        let actual = Request::from(fixture);
    ...
    fn test_response_format_json_schema_serialization() {
        ...
        let fixture = artemis_domain::Context::default()
            .response_format(artemis_domain::ResponseFormat::JsonSchema(Box::new(schema)));
