...
impl From<artemis_domain::ToolChoice> for ToolChoice {
    fn from(value: artemis_domain::ToolChoice) -> Self {
        match value {
            artemis_domain::ToolChoice::None => ToolChoice::None,
            artemis_domain::ToolChoice::Auto => ToolChoice::Auto,
            artemis_domain::ToolChoice::Required => ToolChoice::Required,
            artemis_domain::ToolChoice::Call(tool_name) => ToolChoice::Function {
