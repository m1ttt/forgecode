use artemis_domain::{DefaultTransformation, Provider, ProviderId, Transformer};
use url::Url;
...
mod tests {
    ...
    fn test_zai_provider_applies_thinking_transformation() {
        ...
        let fixture = Request::default().reasoning(artemis_domain::ReasoningConfig {
            enabled: Some(true),
            effort: None,
            max_tokens: None,
            exclude: None,
