        ...
        if let Some(messages) = request.messages.as_mut() {
            for message in messages.iter_mut() {
                ...
                if let Some(ref mut tool_call_id) = message.tool_call_id {
                    *tool_call_id = artemis_domain::ToolCallId::new(
                ...
                if let Some(ref mut id) = message.tool_calls {
                    for tool_call in id.iter_mut() {
                        if let Some(ref mut tool_call_id) = tool_call.id {
                            let trimmed_id =
                                tool_call_id.as_str().chars().take(40).collect::<String>();
                            *tool_call_id = artemis_domain::ToolCallId::new(trimmed_id);
                        }
                    }
                }
            }
...
mod tests {
    ...
    fn test_trim_tool_call_id_in_tool_message() {
        ...
        let fixture = Request::default().messages(vec![Message {
            ...
            content: None,
            name: None,
            tool_call_id: Some(artemis_domain::ToolCallId::new(long_id)),
            tool_calls: None,
    ...
    fn test_trim_tool_call_id_in_assistant_message() {
        ...
        let fixture = Request::default().messages(vec![Message {
            ...
            tool_calls: Some(vec![ResponseToolCall {
                id: Some(artemis_domain::ToolCallId::new(long_id)),
                r#type: FunctionType,
                function: FunctionCall {
                    name: Some(artemis_domain::ToolName::new("test_tool")),
                    arguments: "{}".to_string(),
                },
                extra_content: None,
            }]),
    ...
    fn test_trim_multiple_tool_calls_in_assistant_message() {
        ...
        let fixture = Request::default().messages(vec![Message {
            ...
            tool_calls: Some(vec![
                ResponseToolCall {
                    id: Some(artemis_domain::ToolCallId::new(long_id_1)),
                    r#type: FunctionType,
                    function: FunctionCall {
                        name: Some(artemis_domain::ToolName::new("tool_1")),
                        arguments: "{}".to_string(),
                    },
                    extra_content: None,
                },
                ResponseToolCall {
                    id: Some(artemis_domain::ToolCallId::new(long_id_2)),
                    r#type: FunctionType,
                    function: FunctionCall {
                        name: Some(artemis_domain::ToolName::new("tool_2")),
                        arguments: "{}".to_string(),
                    },
                    extra_content: None,
                },
    ...
    fn test_trim_does_not_affect_short_ids() {
        ...
        let fixture = Request::default().messages(vec![Message {
            ...
            content: None,
            name: None,
            tool_call_id: Some(artemis_domain::ToolCallId::new(short_id)),
            tool_calls: None,
            reasoning_details: None,
            reasoning_text: None,
            reasoning_opaque: None,
    ...
    fn test_trim_exactly_40_chars_id() {
        ...
        let fixture = Request::default().messages(vec![Message {
            ...
            content: None,
            name: None,
            tool_call_id: Some(artemis_domain::ToolCallId::new(exact_id)),
            tool_calls: None,
            reasoning_details: None,
            reasoning_text: None,
            reasoning_opaque: None,
