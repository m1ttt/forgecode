...
use artemis_domain::{TerminalCommand, TerminalContext};
...
impl<S: EnvironmentInfra<Config = artemis_config::ForgeConfig>> TerminalContextService<S> {
...
mod tests {
    ...
    use artemis_domain::{Environment, TerminalCommand, TerminalContext};
