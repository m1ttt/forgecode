...
/// Checks if the Artemis VS Code extension is installed
///
/// Checks VS Code's extension list to see if Artemis.artemis-vscode is
/// installed.
pub fn is_extension_installed() -> bool {
        ...
        && let Ok(extensions) = String::from_utf8(output.stdout)
    {
        return extensions
            .lines()
            .any(|line| line.trim() == "Artemis.artemis-vscode");
    }
    false
}

/// Attempts to install the Artemis VS Code extension silently
///
