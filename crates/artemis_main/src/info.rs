...
use artemis_api::{Conversation, Environment, ForgeConfig, Metrics, Role, Usage, UserUsage};
    ...
    fn from(user_usage: &UserUsage) -> Self {
        ...
        if plan.is_upgradeable() {
            info = info.add_key_value(
                "Subscription",
                format!(
                    "{} [Upgrade https://app.artemis.dev/app/billing]",
...
fn format_user_message(msg: &artemis_api::ContextMessage) -> Option<String> {
    let content = msg
        .as_value()
...
mod tests {
    ...
    use artemis_api::{Environment, EventValue};
    ...
    fn test_metrics_info_display() {
        use artemis_api::Metrics;
        use artemis_domain::{FileOperation, ToolKind};
    ...
    fn test_conversation_info_display() {
        use chrono::Utc;
        use artemis_api::ConversationId;
        use artemis_domain::{FileOperation, ToolKind};
        ...
        let fixture = Conversation {
            ...
            context: None,
            metrics,
            metadata: artemis_domain::MetaData::new(Utc::now()),
        };
    ...
    fn test_conversation_info_display_with_task() {
        use chrono::Utc;
        use artemis_api::{Context, ContextMessage, ConversationId, Role};
        ...
        let context = Context::default()
            ...
            .add_message(ContextMessage::Text(
                artemis_domain::TextMessage::new(Role::User, "First user message")
            ...
            .add_message(ContextMessage::Text(
                artemis_domain::TextMessage::new(Role::User, "Create a new feature")
