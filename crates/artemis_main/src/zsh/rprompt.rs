...
use artemis_domain::{AgentId, ModelId, TokenCount};
...
mod tests {
    ...
    fn test_rprompt_init_state() {
        ...
        let actual = ZshRPrompt::default()
            .agent(Some(AgentId::new("artemis")))
            .model(Some(ModelId::new("gpt-4")))
            .to_string();

        let expected = " %B%F{240}\u{f167a} ARTEMIS%f%b %F{240}\u{ec19} gpt-4%f";
    ...
    fn test_rprompt_with_tokens() {
        ...
        let expected = " %B%F{15}\u{f167a} ARTEMIS%f%b %B%F{15}1.5k%f%b %F{134}\u{ec19} gpt-4%f";
        assert_eq!(actual, expected);
    }
    ...
    fn test_rprompt_with_tokens_and_cost() {
        ...
        let expected = " %B%F{15}\u{f167a} ARTEMIS%f%b %B%F{15}1.5k%f%b %B%F{2}\u{f155}0.01%f%b %F{134}\u{ec19} gpt-4%f";
        assert_eq!(actual, expected);
    }
    ...
    fn test_rprompt_without_nerdfonts() {
        ...
        let expected = " %B%F{15}ARTEMIS%f%b %B%F{15}1.5k%f%b %F{134}gpt-4%f";
        assert_eq!(actual, expected);
    }
    ...
    fn test_rprompt_with_currency_conversion() {
        ...
        let expected = " %B%F{15}\u{f167a} ARTEMIS%f%b %B%F{15}1.5k%f%b %B%F{2}INR0.83%f%b %F{134}\u{ec19} gpt-4%f";
        assert_eq!(actual, expected);
    }
    #[test]
    fn test_rprompt_with_eur_currency() {
        ...
        let expected = " %B%F{15}\u{f167a} ARTEMIS%f%b %B%F{15}1.5k%f%b %B%F{2}€0.01%f%b %F{134}\u{ec19} gpt-4%f";
        assert_eq!(actual, expected);
    }
}
